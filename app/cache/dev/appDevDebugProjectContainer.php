...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/OpenEcoles/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/OpenEcoles/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/OpenEcoles/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/OpenEcoles/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'openEcoles', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_68b8efa54a4aa30fe3645ca17d295144');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_68b8efa54a4aa30fe3645ca17d295144');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_68b8efa54a4aa30fe3645ca17d295144');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\OpenEcoles\\src\\OpenEcoles\\TutorialBundle\\Entity', 1 => 'C:\\wamp\\www\\OpenEcoles\\src\\OpenEcoles\\UserBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\wamp\\www\\OpenEcoles\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity'));
        ...
        $g->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('C:\\wamp\\www\\OpenEcoles\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine\\model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('OpenEcolesTutorialBundle' => 'OpenEcoles\\TutorialBundle\\Entity', 'OpenEcolesUserBundle' => 'OpenEcoles\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('C:/wamp/www/OpenEcoles/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/OpenEcoles/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'secretOpenEcole');
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('OpenEcoles\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('OpenEcoles\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('OpenEcoles\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('OpenEcoles\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'OpenEcoles\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/OpenEcoles/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'open_ecoles_tutorial.gestioncategorie' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return OpenEcoles\TutorialBundle\Services\ActionBDCategorie A OpenEcoles\TutorialBundle\Services\ActionBDCategorie instance.
     */
    protected function getOpenEcolesTutorial_GestioncategorieService()
    {
        return $this->services['open_ecoles_tutorial.gestioncategorie'] = new \OpenEcoles\TutorialBundle\Services\ActionBDCategorie($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'open_ecoles_tutorial.gestionchapitre' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return OpenEcoles\TutorialBundle\Services\ActionBDChapitre A OpenEcoles\TutorialBundle\Services\ActionBDChapitre instance.
     */
    protected function getOpenEcolesTutorial_GestionchapitreService()
    {
        return $this->services['open_ecoles_tutorial.gestionchapitre'] = new \OpenEcoles\TutorialBundle\Services\ActionBDChapitre($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'open_ecoles_tutorial.gestionnote' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return OpenEcoles\TutorialBundle\Services\ActionBDNote A OpenEcoles\TutorialBundle\Services\ActionBDNote instance.
     */
    protected function getOpenEcolesTutorial_GestionnoteService()
    {
        return $this->services['open_ecoles_tutorial.gestionnote'] = new \OpenEcoles\TutorialBundle\Services\ActionBDNote($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'open_ecoles_tutorial.gestiontutoriel' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return OpenEcoles\TutorialBundle\Services\ActionBDTutoriel A OpenEcoles\TutorialBundle\Services\ActionBDTutoriel instance.
     */
    protected function getOpenEcolesTutorial_GestiontutorielService()
    {
        return $this->services['open_ecoles_tutorial.gestiontutoriel'] = new \OpenEcoles\TutorialBundle\Services\ActionBDTutoriel($this->get('doctrine.orm.default_entity_manager'), $this->get('open_ecoles_tutorial.gestionchapitre'));
    }

    /**
     * Gets the 'open_ecoles_tutorial.validationtutoriel' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return OpenEcoles\TutorialBundle\Services\validateTutoriel A OpenEcoles\TutorialBundle\Services\validateTutoriel instance.
     */
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/OpenEcoles/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/OpenEcoles/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/OpenEcoles/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Tutoriel');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Tutoriel/Admin');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/Site');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/OpenEcoles/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/OpenEcoles/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/wamp/www/OpenEcoles/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/OpenEcoles/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/OpenEcoles/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/wamp/www/OpenEcoles/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/OpenEcoles/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/OpenEcoles/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:/wamp/www/OpenEcoles/app/Resources/TwigBundle/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\src\\OpenEcoles\\BackOfficeBundle/Resources/views', 'OpenEcolesBackOffice');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\src\\OpenEcoles\\FrontOfficeBundle/Resources/views', 'OpenEcolesFrontOffice');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\src\\OpenEcoles\\AnnexeBundle/Resources/views', 'OpenEcolesAnnexe');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\src\\OpenEcoles\\TutorialBundle/Resources/views', 'OpenEcolesTutorial');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\stfalcon\\tinymce-bundle\\Stfalcon\\Bundle\\TinymceBundle/Resources/views', 'StfalconTinymce');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\src\\OpenEcoles\\UserBundle/Resources/views', 'OpenEcolesUser');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\src\\OpenEcoles\\OpenAnnoncesBundle/Resources/views', 'OpenEcolesOpenAnnonces');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/OpenEcoles/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\OpenEcoles\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('secretOpenEcole');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/OpenEcoles/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/OpenEcoles/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/OpenEcoles/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp\\www\\OpenEcoles\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'C:\\wamp\\www\\OpenEcoles\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml', 2 => 'C:\\wamp\\www\\OpenEcoles\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/OpenEcoles/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/OpenEcoles/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/OpenEcoles/app/logs',
            'kernel.bundles' => array(
                ...
                'OpenEcolesBackOfficeBundle' => 'OpenEcoles\\BackOfficeBundle\\OpenEcolesBackOfficeBundle',
                'OpenEcolesFrontOfficeBundle' => 'OpenEcoles\\FrontOfficeBundle\\OpenEcolesFrontOfficeBundle',
                'OpenEcolesAnnexeBundle' => 'OpenEcoles\\AnnexeBundle\\OpenEcolesAnnexeBundle',
                'OpenEcolesTutorialBundle' => 'OpenEcoles\\TutorialBundle\\OpenEcolesTutorialBundle',
            ...
            'debug.container.dump' => 'C:/wamp/www/OpenEcoles/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/OpenEcoles/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp\\www\\OpenEcoles\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
                1 => 'C:\\wamp\\www\\OpenEcoles\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'C:\\wamp\\www\\OpenEcoles\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/OpenEcoles/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/OpenEcoles/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/OpenEcoles/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/OpenEcoles/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/OpenEcoles/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/OpenEcoles/app/../web',
            'assetic.write_to' => 'C:/wamp/www/OpenEcoles/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/OpenEcoles/app/cache/dev/doctrine/orm/Proxies',
            ...
            'backbundles' => array(
                0 => array(
                    'name' => 'Tutoriel',
                    'menu_name' => 'Catégories & tutoriels',
                    'accueil' => 'open_ecoles_tutorial_back_homepage',
                ),
            ),
            ...
            'fos_user.model.user.class' => 'OpenEcoles\\UserBundle\\Entity\\User',
