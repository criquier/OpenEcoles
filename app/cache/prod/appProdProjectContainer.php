...
class appProdProjectContainer extends Container
{
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'openecoles_user.registration.form.type' => 'getOpenecolesUser_Registration_Form_TypeService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/opt/lampp/htdocs/OpenEcoles/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/opt/lampp/htdocs/OpenEcoles/app/cache/prod/assetic/config'), false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'openEcoles', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8d74e008937a01a69d56e1a49ad0af4e');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8d74e008937a01a69d56e1a49ad0af4e');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_8d74e008937a01a69d56e1a49ad0af4e');
        ...
        $i->setProxyDir('/opt/lampp/htdocs/OpenEcoles/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('openecolesuser.gestionnaireutilisateur.post_message', array(0 => 'openecoles_user.gestionenvoiemessages', 1 => 'onMessagePost'), 0);
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/opt/lampp/htdocs/OpenEcoles/app/logs/prod.log', 100, true);
    }
    ...
    protected function getOpenecolesUser_GestionbdmessagesService()
    {
        return $this->services['openecoles_user.gestionbdmessages'] = new \OpenEcoles\UserBundle\Services\MessageBDServices($this->get('doctrine.orm.default_entity_manager'));
    }
    protected function getOpenecolesUser_GestionbdusersService()
    {
        return $this->services['openecoles_user.gestionbdusers'] = new \OpenEcoles\UserBundle\Services\UserBDServices($this->get('doctrine.orm.default_entity_manager'));
    }
    protected function getOpenecolesUser_GestionenvoiemessagesService()
    {
        return $this->services['openecoles_user.gestionenvoiemessages'] = new \OpenEcoles\UserBundle\Services\MessageListenerService($this->get('openecoles_user.gestionbdmessages'), $this->get('openecoles_user.gestionbdusers'));
    }
    protected function getOpenecolesUser_Registration_Form_TypeService()
    {
        return $this->services['openecoles_user.registration.form.type'] = new \OpenEcoles\UserBundle\Form\Type\RegistrationFormType('OpenEcoles\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/opt/lampp/htdocs/OpenEcoles/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/opt/lampp/htdocs/OpenEcoles/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/opt/lampp/htdocs/OpenEcoles/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/opt/lampp/htdocs/OpenEcoles/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/opt/lampp/htdocs/OpenEcoles/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/opt/lampp/htdocs/OpenEcoles/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/opt/lampp/htdocs/OpenEcoles/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/opt/lampp/htdocs/OpenEcoles/app/cache/prod',
            ...
            'session.save_path' => '/opt/lampp/htdocs/OpenEcoles/app/cache/prod/sessions',
            ...
            'router.resource' => '/opt/lampp/htdocs/OpenEcoles/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/opt/lampp/htdocs/OpenEcoles/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/opt/lampp/htdocs/OpenEcoles/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/opt/lampp/htdocs/OpenEcoles/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/opt/lampp/htdocs/OpenEcoles/app/cache/prod/doctrine/orm/Proxies',
